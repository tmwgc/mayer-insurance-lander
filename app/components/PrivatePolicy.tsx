    ...
    <div className={styles.frame1612}>
      ...
      <div className={styles.informationSection}>
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sectionDescription}>
            When you engage with us through text messaging, we may collect personal information such
            as your name, phone number, policy details, and other relevant information necessary to
      ...
      <div className={styles.howWeUseYourInformationSection}>
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sectionDescription}>
            We use the information collected through text messaging solely for internal purposes,
            including providing insurance services, responding to inquiries, and managing your
            insurance policies.
          </div>
        </div>
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sectionDescription}>
            We may use text messaging to communicate with you about your insurance policies,
            updates, reminders, and other relevant information related to our services.
          </div>
        </div>
      </div>

      <div className={styles.informationSharingAndDisclosureSection}>
        <div className={styles.sectionTitle}>Information Sharing and Disclosure</div>
        <div className={styles.sectionContent}>
          <div className={styles.sectionSubtitle}>No Disclosure to Third Parties</div>
          <div className={styles.sectionDescription}>
            We do not disclose any information collected through text messaging to third-party
            companies or external entities for marketing or other purposes.
          </div>
        </div>
      </div>
      ...
      <div className={styles.dataSecuritySection}>
        ...
        <div className={styles.sectionDescription}>
          ...
          confidentiality of your information collected through text messaging. However, no method
      ...
      <div className={styles.dataRetentionSection}>
        ...
        <div className={styles.sectionDescription}>
          We retain the information collected through text messaging only for as long as necessary
          to fulfill the purposes outlined in this Privacy Policy and as required by applicable laws
          and regulations.
        </div>
      </div>
      ...
      <div className={styles.yourRightsSection}>
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sectionDescription}>
            You have the right to access and correct your personal information collected through
            text messaging.
          </div>
        </div>
        <div className={styles.sectionContent}>
          ...
          <div className={styles.sectionDescription}>
            You may choose to opt-out of receiving text messages from us at any time by following
            the opt-out instructions provided in the text messages or by contacting us directly.
          </div>
        </div>
        <div className={styles.sectionContent}>
          <div className={styles.sectionSubtitle}>Data Deletion</div>
          <div className={styles.sectionDescription}>
            You may request the deletion of your personal information collected through text
            messaging, subject to legal and contractual obligations.
          </div>
        </div>
      </div>
      ...
      <div className={styles.childrenPrivacySection}>
        ...
        <div className={styles.sectionDescription}>
          Our text messaging services are not directed to individuals under the age of 18, and we do
      ...
      <div className={styles.updatesToPrivacyPolicySection}>
        ...
        <div className={styles.sectionDescription}>
          We may update this Privacy Policy for text messaging from time to time. We will notify you
          of any material changes by posting the updated Privacy Policy on our website or by sending
          you a notification through text messaging.
        </div>
      </div>
      ...
      <div className={styles.sectionDescription}>
        By engaging with us through text messaging, you consent to the collection, use, and
